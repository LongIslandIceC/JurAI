...
// ===================================
// PDF Preview Modal - Apple Liquid Glass
// ===================================
function initPdfModal() {
    ...
    // Open modal when clicking preview buttons
    document.querySelectorAll('[data-pdf-preview]').forEach(btn => {
        btn.addEventListener('click', (e) => {
            e.preventDefault();
            const pdfUrl = btn.getAttribute('data-pdf-preview');
            const title = btn.getAttribute('data-pdf-title') || 'Vertragsvorlage';
