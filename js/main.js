...
if (kontaktForm) {
    kontaktForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            // Show error message
            showFormMessage('Es ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut oder senden Sie eine E-Mail direkt an christopher@juraiconsulting.com', 'error');
        } finally {
            // Reset button
